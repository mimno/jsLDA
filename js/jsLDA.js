function main() {
	...
	// 2016-04-01 OD: Put defaults here for easy reference
  ...
  // 2016-04-01 OD: Move all functions for downloading results to downloadResults.js 

  queue()
    .defer(d3.text, stopwordsURL)
    .defer(d3.text, documentsURL)
    .await(processFiles); // 2016-04-01 OD: Changed name from "ready" to "dataLoaded" and changed to use ".awaitALL"
