var ui = (function(){
    ...
    var numTopics;
    var wordTopicCounts;
    var documentTopicSmoothing;
    var topicWordSmoothing;
    var vocabularySize;
    var vocabularyCounts;
    var selectedTopic;

    // Constants for calculating topic correlation.
    var correlationMinTokens;
    var correlationMinProportion;
    ...
    var docSortSmoothing;
    var sumDocSortSmoothing;
    var selectedTopic;
  ...
  //  var reoderDocuments = {}; //initialize so inner functions can find it
  return {
