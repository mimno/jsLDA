...
(function(root, factory) {
  ...
  merge(Spinner.prototype, {
      ...
      function fill(color, shadow) {
        return css(createEl(), {
          ...
          transform: 'rotate(' + ~~(360 / o.lines * i + o.rotate) +
            'deg) translate(' + o.scale * o.radius + 'px' + ',0)',
          borderRadius: (o.corners * o.scale * o.width >> 1) +
            'px'
        })
      }
      ...
      for (; i < o.lines; i++) {
        seg = css(createEl(), {
          ...
          animation: useCssAnimations && addAnimation(o.opacity,
              o.trail, start + i * o.direction, o.lines) + ' ' +
        ...
        ins(el, ins(seg, fill(getColor(o.color, i),
    ...
    opacity: function(el, i, val) {
      if (i < el.childNodes.length) el.childNodes[i].style.opacity =
        val
    }
